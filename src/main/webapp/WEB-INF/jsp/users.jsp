    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${users}" var="user">
                ...
                <tr id="${user.id}" class="${user.enabled ? "" : "table-warning"}">
                    ...
                    <td>${user.roles}</td>
                    <td>
                        <input class="user-checkbox" type="checkbox" <c:if test="${user.enabled}">checked</c:if>/>
                    </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" onclick="closeNotification()">
                    &times;
                </button>
            </div>
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="password" class="col-form-label"><spring:message code="user.password"/>
                        </label>
