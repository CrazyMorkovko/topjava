...
public class ExceptionInfoHandler {
    ...
    public ResponseEntity<ErrorInfo> applicationError(HttpServletRequest req, ApplicationException appEx) {
        return ResponseEntity.status(appEx.getType().getStatus()).body(logAndGetErrorInfo(
                req,
                appEx,
                false,
                appEx.getType(),
    ...
    public ErrorInfo bindValidationError(HttpServletRequest req, Exception e) {
        ...
        return logAndGetErrorInfo(req, e, false, VALIDATION_ERROR, result.getFieldErrors().stream()
    ...
    private ErrorInfo logAndGetErrorInfo(
        ...
        return new ErrorInfo(req.getRequestURL(), errorType,
                ...
                details.length != 0 ? details : new String[]{ValidationUtil.getMessage(
                        ValidationUtil.logAndGetRootCause(log, req, e, logException, errorType)
                )});
    }
}