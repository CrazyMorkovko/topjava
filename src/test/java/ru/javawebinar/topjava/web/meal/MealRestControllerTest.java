...
public class MealRestControllerTest extends AbstractControllerTest {
    ...
    void getBetween() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "filter?startDate=" + START_DATE + "&endDate=" +
                END_DATE + "&startTime=" + START_TIME + "&endTime=" + END_TIME))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MEAL_TO_MATCHER.contentJson(MealsUtil.getFilteredTos(
                        mealService.getBetweenInclusive(START_DATE, END_DATE, USER_ID),
    ...
    void createWithLocation() throws Exception {
        ...
        Meal created = TestUtil.readFromJson(
        ...
        MEAL_MATCHER.assertMatch(mealService.get(meal.id(), USER_ID), meal);
    }
}
